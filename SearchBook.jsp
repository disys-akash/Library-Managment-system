...
<h2 align="center"><font><strong>Enter Book Name to show the List of Books available in this Library</strong></font></h2>
...
try{ 
  ...
  if(con!= null){System.out.println("connected Succesfully");}
   ...
   String reset_n ="\'" + n +"%"+"\'";
   String q = "select * from Books_Details WHERE Book_Name LIKE"+reset_n; 
